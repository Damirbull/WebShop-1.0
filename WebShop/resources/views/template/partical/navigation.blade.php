...
<body>
@extends('template.partical.popup')
<nav>
    <ul class="nav-list">
        <li class="nav-item">
...
{{--        </li>--}}
        <li class="nav-item">
            <a href="#modalOverlay" class="modal-button" style="color: inherit; text-decoration: none;">Добавить Товар</a>
        </li>
        @if(auth()->check() && auth()->user()->admin === '1')
            <li class="nav-item">
        ...
        <li class="nav-item">
            <a  href="/catalog">
                <button class="btn-primary">Мои товары</button>
            </a>
        </li>
    </ul>
</nav>
